...
// Configured with your exact hosting details
const dbConfig = {
    host: '51.83.49.125', 
...
export async function execute(interaction) {
    ...
    try {
        ...
        console.error(error);
        return interaction.reply({ content: '❌ Could not connect to the database. Verify your credentials.', ephemeral: true });
    }
}

// Added for TitanBot's dynamic handler framework integration
